...
namespace layers
{
SubGradientOper::SubGradientOper(Tensor::SPtr in1, Tensor::SPtr in2,
                                 Tensor::SPtr out, Tensor::SPtr outGrad)
    : Oper({in1, in2, out, outGrad}, createOutputs(in1, in2))
{
}

std::vector<Tensor::SPtr> SubGradientOper::createOutputs(Tensor::SPtr in1,
                                                         Tensor::SPtr in2)
{
...
void SubGradientOper::executeOper(const InputDict& inputs)
{
...
GradientOper::TensorMap SubOper::gradients(Tensor::SPtr output,
...
Tensor::SPtr sub(Tensor::SPtr t1, Tensor::SPtr t2)
{
    ...
    Oper::SPtr oper = std::make_shared<layers::SubOper>(t1, t2);
